...
class SysLog(View):
    def get(self, request):
        ...
        connHandler.useCacheData(cache)
        ...
        connHandler_private_server.useCacheData(cache)
        ...
        connHandler_backup_cpu.useCacheData(cache)
        ...
        connHandler_backup_mem.useCacheData(cache)
        ...
        connHandler_webserver_cpu.useCacheData(cache)
